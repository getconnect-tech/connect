...
const getPath = (name: string, props: any) => {
  ...
  switch (name) {
    ...
    case 'secondary-logo':
      return (
        <>
          <rect width={60} height={60} fill='#0D0D0F' rx={30} />
          <path
            fill='#fff'
            d='M38.45 41.885c1.008-1.056 1.68-2.113 2.4-3.313.817-1.297 1.249-1.73 2.065-1.73 1.393 0 1.729.961 1.729 2.69v.336c-.096 3.121-.672 4.562-2.113 5.618-1.777 1.297-5.522 2.21-9.364 2.21-11.573 0-17.815-8.74-17.815-17.528 0-8.932 6.434-17.863 18.583-17.863 3.41 0 6.483.72 8.116 1.728 2.017 1.249 2.017 2.353 2.017 4.658v.48c0 2.402-.337 3.266-1.633 3.266-1.105 0-1.44-.48-2.017-1.44-.624-1.01-1.392-2.594-3.217-3.938-1.249-.913-2.785-1.44-4.514-1.44-5.955 0-10.276 5.858-10.276 13.877 0 .528 0 1.056.047 1.584.625 8.932 5.619 13.062 10.613 13.062 2.16 0 3.986-.817 5.378-2.257Z'
          />
        </>
      );
    case 'up-arrow-icon':
