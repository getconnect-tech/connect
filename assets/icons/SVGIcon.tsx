...
const getPath = (name: string, props: any) => {
  ...
  switch (name) {
    ...
    case 'left-arrow-icon':
      return (
        <>
          <path
            fill='#C4C3C1'
            d='m2.804 8.121 2.946-3.13-2.946-3.13a.754.754 0 0 1-.193-.513.753.753 0 0 1 .2-.51.667.667 0 0 1 .48-.213.665.665 0 0 1 .483.205l3.431 3.646c.129.136.201.322.201.515a.753.753 0 0 1-.2.516L3.773 9.152a.687.687 0 0 1-.223.164.652.652 0 0 1-.756-.155.77.77 0 0 1 .009-1.04Z'
          />
        </>
      );
    ...
    case 'sticky-note-icon':
      return (
        <>
          <path
            fill={fill}
            d='M9.253 8h2.227c-.04.06-.087.107-.14.16l-3.18 3.18c-.053.053-.1.1-.16.14V9.253C8 8.56 8.56 8 9.253 8ZM12 2.247v4.32c0 .146-.013.293-.047.433h-2.7A2.25 2.25 0 0 0 7 9.253v2.7c-.14.034-.287.047-.433.047H2.253C.747 12 0 11.247 0 9.747v-7.5C0 .747.747 0 2.253 0h7.494C11.253 0 12 .747 12 2.247ZM6.5 7.333a.5.5 0 0 0-.5-.5H3.333a.5.5 0 0 0 0 1H6a.5.5 0 0 0 .5-.5Zm2.667-3a.5.5 0 0 0-.5-.5H3.333a.5.5 0 0 0 0 1h5.334a.5.5 0 0 0 .5-.5Z'
          />
        </>
      );
      ...
      return (
        <>
          <g clipPath='url(#a)'>
            <path
              fill={fill}
              d='M6 0a6 6 0 0 1 6 6 .643.643 0 1 1-1.286 0A4.714 4.714 0 1 0 6 10.714.643.643 0 1 1 6 12 6 6 0 1 1 6 0Zm3.643 7.286a.643.643 0 0 1 .637.555l.006.088v1.07L11.357 9a.643.643 0 0 1 .637.555l.006.088a.643.643 0 0 1-.555.637l-.088.006-1.071-.001v1.072a.643.643 0 0 1-1.28.088L9 11.357v-1.072H7.929a.643.643 0 0 1-.637-.555l-.006-.087a.643.643 0 0 1 .555-.637L7.93 9H9V7.928a.643.643 0 0 1 .643-.643ZM8.12 6a.429.429 0 0 1 .426.474c-.149 1.398-.994 2.097-2.533 2.097s-2.39-.697-2.556-2.092a.429.429 0 0 1 .375-.476L3.86 6 8.12 6ZM4.286 3.429a.857.857 0 1 1 0 1.714.857.857 0 0 1 0-1.714Zm3.428 0a.857.857 0 1 1 0 1.714.857.857 0 0 1 0-1.714Z'
            />
          </g>
          <defs>
            <clipPath id='a'>
    ...
    case 'pdf-icon':
      return (
        <>
          <path
            fill='#E5252A'
            d='M14.431 5.082v9.343c0 .87-.705 1.575-1.575 1.575H3.142c-.87 0-1.575-.705-1.575-1.575V1.575C1.567.705 2.272 0 3.142 0h6.506l4.783 5.082Z'
          />
          <path
            fill='#F1777A'
            d='M14.431 5.082H10.7c-.58 0-1.05-.47-1.05-1.05V0l4.783 5.082Z'
          />
          <path
            fill='#FEFEFE'
            fillRule='evenodd'
            d='M7.905 7.053s-.032.172-.097.464c-.066.292-.12.409-.12.409s-.182-.484-.216-1.068c-.032-.581-.032-.817.085-.937.12-.121.292.205.333.346.044.141.098.452.098.452s.073-.33.043-.625C8 5.8 7.58 5.8 7.58 5.8s-.518.002-.506.391c.01.39-.032.528.085 1.185a22.404 22.404 0 0 0 .236 1.136l.022.095s-.302.732-.993 2.112c-.69 1.379-1.282 2.123-1.498 2.35-.217.226-.723.55-.603.236.119-.312.452-.767.732-.993l.484-.39s.085-.128-.141-.043c-.227.085-.73.409-1.068.82-.336.409-.409.562-.248.732.16.17.442.236.732.085.292-.15.808-.678 1.024-1.056.217-.377.506-.86.506-.86s.506-.217 1.392-.4a47.11 47.11 0 0 1 1.627-.309c.277.154.572.275.895.385.852.292.959.28 1.273.292.31.01.469-.183.469-.258 0-.076-.06-.151-.06-.151s-.066.345-1.23-.075c-.284-.103-.52-.19-.722-.278.258-.024.582-.046.949-.046.924 0 1.063.258 1.002.258.173-.43-.572-.572-1.175-.572-.406 0-.949.073-1.262.122-.356-.21-.635-.467-1.024-.92-.324-.377-.545-.858-.691-1.274.1-.446.19-1.005.107-1.321h.012Zm1.107 3.617c-.28.041-.713.124-1.226.282-.905.28-1.316.443-1.316.443s.452-.808.647-1.207a30.09 30.09 0 0 0 .5-1.138 5 5 0 0 0 .502.761c.287.365.579.64.893.859Z'
            clipRule='evenodd'
          />
        </>
      );
    case 'download-alt-icon':
      return (
        <>
          <path
            fill={fill}
            d='M1.399 4.934a.633.633 0 0 1 .435-1.094h1.55V.64a.64.64 0 0 1 .64-.64h3.84a.64.64 0 0 1 .64.64v3.2h1.66c.574 0 .852.7.435 1.094L6.583 8.728a.851.851 0 0 1-1.168 0L1.399 4.934Zm9.08 6.106H1.52a.48.48 0 0 0 0 .96h8.96a.48.48 0 0 0 0-.96Z'
          />
        </>
      );
    case 'doc-icon':
      return (
        <>
          ...
          <path
            fill='#fff'
            d='M4.494 7.39a.39.39 0 0 1 .39-.389h6.232a.39.39 0 1 1 0 .78H4.884a.39.39 0 0 1-.39-.39Zm0 1.74a.39.39 0 0 1 .39-.389h6.232a.39.39 0 1 1 0 .78H4.884a.39.39 0 0 1-.39-.39Zm0 1.741a.39.39 0 0 1 .39-.39h6.232a.39.39 0 1 1 0 .78H4.884a.39.39 0 0 1-.39-.39Zm0 1.74a.39.39 0 0 1 .39-.39H9.09a.39.39 0 1 1 0 .78H4.883a.39.39 0 0 1-.39-.39Z'
          />
        </>
      );
    case 'excel-icon':
      return (
        <>
          ...
          <path
            fill='#fff'
            fillRule='evenodd'
            d='M4.495 12.51c0-.271.22-.491.491-.491h2.046a.491.491 0 0 1 0 .982H4.986a.491.491 0 0 1-.49-.491Zm3.973-5.022c0-.269.218-.487.487-.487h2.063a.487.487 0 0 1 0 .974H8.955a.487.487 0 0 1-.487-.487Zm-3.973 0c0-.269.218-.487.487-.487h2.054a.487.487 0 1 1 0 .974H4.982a.487.487 0 0 1-.487-.487Zm3.973 1.655c0-.272.22-.491.49-.491h2.056a.491.491 0 0 1 0 .982H8.96a.491.491 0 0 1-.491-.491Zm-3.973 0c0-.272.22-.491.491-.491h2.046a.491.491 0 0 1 0 .982H4.986a.491.491 0 0 1-.49-.491Zm3.973 1.716c0-.271.22-.49.49-.49h2.056a.491.491 0 1 1 0 .981H8.96a.491.491 0 0 1-.491-.49Zm-3.973 0c0-.271.22-.49.491-.49h2.046a.491.491 0 1 1 0 .981H4.986a.491.491 0 0 1-.49-.49Zm3.973 1.65c0-.27.22-.49.49-.49h2.056a.491.491 0 0 1 0 .982H8.96a.491.491 0 0 1-.491-.491Z'
            clipRule='evenodd'
          />
        </>
      );
    case 'csv-icon':
      return (
        <>
          ...
          <path
            fill='#fff'
            d='M11.5 10.64h-7v.524h7v-.523Zm0-1.795h-7v.524h7v-.524Z'
          />
          <path
            fill='#fff'
            d='M6.617 7.001h.524v6.008h-.524V7.001ZM9.384 7.001H8.86v6.008h.524V7.001Z'
          />
        </>
      );
    case 'mp4-icon':
      return (
        <>
          ...
          <path
            fill='#fff'
            d='M8.003 6.254a3.755 3.755 0 0 0-3.753 3.753 3.75 3.75 0 0 0 7.5 0 3.758 3.758 0 0 0-3.747-3.753Zm1.578 3.87a.308.308 0 0 1-.122.121l-2.14 1.073a.269.269 0 0 1-.36-.122.211.211 0 0 1-.03-.121v-2.14c0-.152.123-.268.268-.268.04 0 .08.006.121.03l2.14 1.067a.27.27 0 0 1 .123.36Z'
          />
        </>
      );
    case 'common-file-icon':
      return (
        <>
          <path
            fill='#C4C3C1'
    ...
    case 'users-icon':
      return (
        <>
          <path
            fill='#fff'
            d='M7 0a7 7 0 1 0 0 14A7 7 0 0 0 7 0Zm.006 3.5a2.1 2.1 0 1 1 0 4.2 2.1 2.1 0 0 1 0-4.2ZM7 12.95a5.92 5.92 0 0 1-4.018-1.568c.308-.966 1.106-1.883 2.821-1.883h2.394c1.708 0 2.506.924 2.821 1.883A5.92 5.92 0 0 1 7 12.95Z'
          />
        </>
      );
    ...
    case 'notification-icon':
      return (
        <>
          <path
            fill='#fff'
            d='M8.594 12.711a.369.369 0 0 1-.001.37A1.83 1.83 0 0 1 7 14a1.83 1.83 0 0 1-1.593-.92.369.369 0 0 1 .318-.554h2.55a.37.37 0 0 1 .32.185Zm4.589-1.52c-.014-.017-1.397-1.773-1.397-3.823V4.786A4.792 4.792 0 0 0 7 0a4.792 4.792 0 0 0-4.786 4.786v2.582c0 2.05-1.382 3.806-1.397 3.823a.369.369 0 0 0 .287.598h11.79c.141 0 .27-.08.332-.208a.367.367 0 0 0-.043-.39Z'
          />
        </>
      );
    case 'refresh-icon':
      return (
        <>
          <path
            fill='#7B7A79'
            d='M12 1.2v3a.6.6 0 0 1-.6.6h-3a.6.6 0 1 1 0-1.2h1.746A4.796 4.796 0 0 0 6 1.2a4.783 4.783 0 0 0-4.768 4.265.6.6 0 0 1-1.192-.13A5.982 5.982 0 0 1 6 0c1.922 0 3.689.921 4.8 2.405V1.2a.6.6 0 1 1 1.2 0Zm-.57 4.804a.597.597 0 0 0-.662.532A4.782 4.782 0 0 1 6 10.8a4.796 4.796 0 0 1-4.146-2.4H3.6a.6.6 0 1 0 0-1.2h-3a.6.6 0 0 0-.6.6v3a.6.6 0 1 0 1.2 0V9.595A6.003 6.003 0 0 0 6 12a5.982 5.982 0 0 0 5.961-5.335.6.6 0 0 0-.532-.661Z'
          />
        </>
      );
    case 'bullet-list-icon':
      return (
        <>
          <path
            fill={fill}
            d='M1.5 3.375a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Zm3-1.5a.75.75 0 0 1 .75-.75h6a.75.75 0 0 1 0 1.5h-6a.75.75 0 0 1-.75-.75ZM3 6a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0ZM4.5 6a.75.75 0 0 1 .75-.75h6a.75.75 0 0 1 0 1.5h-6A.75.75 0 0 1 4.5 6ZM3 10.125a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0ZM4.5 10.125a.75.75 0 0 1 .75-.75h6a.75.75 0 0 1 0 1.5h-6a.75.75 0 0 1-.75-.75Z'
          />
        </>
      );
    case 'bold-icon':
      return (
        <>
          <path
            fill={fill}
            fillRule='evenodd'
            d='M1.04.857c0-.373.301-.675.674-.675H6.75a3.246 3.246 0 0 1 0 6.493H1.714A.675.675 0 0 1 1.04 6V.857Zm1.35.675v3.793h4.36a1.896 1.896 0 0 0 0-3.793H2.39Z'
            clipRule='evenodd'
          />
          <path
            fill={fill}
            fillRule='evenodd'
            d='M1.04 6c0-.373.301-.675.674-.675h6a3.246 3.246 0 1 1 0 6.493h-6a.675.675 0 0 1-.675-.675V6Zm1.35.675v3.793h5.324a1.896 1.896 0 1 0 0-3.793H2.39Z'
            clipRule='evenodd'
          />
        </>
      );
      ...
      return (
        <>
          <path
            fill={fill}
            fillRule='evenodd'
            d='M7.45.202c.361.09.58.457.49.819L5.37 11.307a.675.675 0 0 1-1.31-.328L6.63.693a.675.675 0 0 1 .82-.49Z'
            clipRule='evenodd'
          />
          <path
            fill={fill}
            fillRule='evenodd'
            d='M1.04 11.143c0-.373.301-.675.674-.675h6a.675.675 0 1 1 0 1.35h-6a.675.675 0 0 1-.675-.675ZM3.611.857c0-.373.303-.675.675-.675h6a.675.675 0 1 1 0 1.35h-6a.675.675 0 0 1-.675-.675Z'
            clipRule='evenodd'
          />
        </>
      );
      ...
      return (
        <>
          <path
            fill={fill}
            fillRule='evenodd'
            d='M2.8.125c.373 0 .675.302.675.675v4.8a2.525 2.525 0 1 0 5.05 0V.8a.675.675 0 0 1 1.35 0v4.8a3.875 3.875 0 0 1-7.75 0V.8c0-.373.302-.675.675-.675ZM1.324 11.2c0-.373.302-.675.675-.675h8a.675.675 0 0 1 0 1.35H2a.675.675 0 0 1-.675-.675Z'
            clipRule='evenodd'
          />
        </>
      );
      ...
      return (
        <>
          <path
            fill={fill}
            fillRule='evenodd'
            d='M4.348 2.252c0-.388.314-.703.702-.703h6.248a.703.703 0 0 1 0 1.405H5.05a.703.703 0 0 1-.702-.702Z'
            clipRule='evenodd'
          />
          <path
            fill={fill}
            fillRule='evenodd'
            d='M8.173 1.549c.388 0 .703.314.703.702V9.75a.703.703 0 0 1-1.405 0V2.25c0-.388.314-.702.702-.702ZM0 4.753c0-.258.21-.468.468-.468h4.165a.468.468 0 0 1 0 .936H.468A.468.468 0 0 1 0 4.753Z'
            clipRule='evenodd'
          />
          <path
            fill={fill}
            fillRule='evenodd'
            d='M2.55 4.284c.259 0 .469.21.469.469V9.75a.468.468 0 0 1-.937 0V4.753c0-.259.21-.469.468-.469Z'
            clipRule='evenodd'
          />
        </>
      );
    case 'blockquote-icon':
      return (
        <>
          <path
            fill={fill}
            d='M2.5 1.625a2.5 2.5 0 1 0 0 5c.056 0 .109-.013.164-.017a6.482 6.482 0 0 1-1.33 2.349 1 1 0 0 0 1.49 1.336A8.483 8.483 0 0 0 5 4.625a.95.95 0 0 0-.034-.167c.019-.11.03-.221.034-.333a2.5 2.5 0 0 0-2.5-2.5ZM12 4.125a2.5 2.5 0 1 0-2.5 2.5c.056 0 .109-.013.164-.017a6.482 6.482 0 0 1-1.33 2.349 1 1 0 0 0 1.49 1.336A8.483 8.483 0 0 0 12 4.625a.95.95 0 0 0-.034-.167c.019-.11.03-.221.034-.333Z'
          />
        </>
      );
    case 'code-block-icon':
      return (
        <>
          <g clip-path='url(#clip0_3601_13148)'>
            <path
              d='M5.74286 5.40003L1.45714 1.11432C1.11429 0.771463 0.6 0.771463 0.257143 1.11432C-0.0857143 1.45718 -0.0857143 1.97146 0.257143 2.31432L3.94286 6.00003L0.257143 9.68575C-0.0857143 10.0286 -0.0857143 10.5429 0.257143 10.8857C0.428571 11.0572 0.6 11.1429 0.857143 11.1429C1.11429 11.1429 1.28571 11.0572 1.45714 10.8857L5.74286 6.60003C6.08571 6.25718 6.08571 5.74289 5.74286 5.40003Z'
              fill={fill}
            />
            <path
              d='M11.1429 9.42871H6.85714C6.38376 9.42871 6 9.81245 6 10.2859C6 10.7593 6.38376 11.143 6.85714 11.143H11.1429C11.6163 11.143 12 10.7593 12 10.2859C12 9.81245 11.6163 9.42871 11.1429 9.42871Z'
              fill={fill}
            />
          </g>
          <defs>
            <clipPath id='clip0_3601_13148'>
    ...
    case 'link-icon':
      return (
        <>
          <path
            fill={fill}
            d='M9.34 7.528a.6.6 0 0 1-.425-1.023l1.18-1.187a2.375 2.375 0 0 0 .706-1.703c0-.648-.25-1.255-.705-1.71-.94-.94-2.47-.939-3.412 0l-1.18 1.186a.6.6 0 0 1-.85-.846l1.18-1.186a3.618 3.618 0 0 1 5.11-.002 3.59 3.59 0 0 1 1.057 2.558c0 .971-.376 1.878-1.059 2.553L9.765 7.352a.6.6 0 0 1-.425.176Zm-3.175 3.416 1.188-1.18a.6.6 0 1 0-.846-.851l-1.188 1.182c-.942.94-2.472.94-3.413 0-.94-.941-.94-2.471 0-3.41l1.187-1.182a.6.6 0 1 0-.846-.85L1.059 5.835a3.616 3.616 0 0 0 0 5.108A3.604 3.604 0 0 0 3.614 12a3.59 3.59 0 0 0 2.551-1.055Zm-1.54-2.72L8.241 4.61a.6.6 0 1 0-.849-.848L3.777 7.376a.6.6 0 1 0 .848.848Z'
          />
        </>
      );
    case 'dropdown-icon':
      return (
        <>
          <path
            fill={fill}
            d='M6.497 2.243 3.993 4.6 1.489 2.243a.603.603 0 0 0-.41-.154.602.602 0 0 0-.408.16.533.533 0 0 0-.171.384.532.532 0 0 0 .164.386L3.58 5.764c.11.103.258.161.413.161a.602.602 0 0 0 .412-.16l2.917-2.746a.55.55 0 0 0 .178-.39.521.521 0 0 0-.17-.393.587.587 0 0 0-.418-.16.614.614 0 0 0-.415.167Z'
          />
        </>
      );
    case 'strikethrough-icon':
      return (
        <>
          <path
            fill={fill}
            fillRule='evenodd'
            d='M6.57 6.424a.675.675 0 0 1 .873-.387l.21.081a3.046 3.046 0 0 1 1.949 2.84v.005a3.046 3.046 0 0 1-3.046 3.045H4.778a3.046 3.046 0 0 1-3.046-3.045.675.675 0 1 1 1.35 0c0 .936.76 1.695 1.696 1.695h1.778c.937 0 1.696-.759 1.696-1.695v-.004a1.696 1.696 0 0 0-1.085-1.581l-.21-.082a.675.675 0 0 1-.387-.872Z'
            clipRule='evenodd'
          />
          <path
            fill={fill}
            fillRule='evenodd'
            d='M-.008 6.667c0-.373.302-.675.675-.675h10.667a.675.675 0 0 1 0 1.35H.667a.675.675 0 0 1-.675-.675ZM4.868 1.342c-.986 0-1.786.8-1.786 1.785 0 .42.16.819.438 1.144a.675.675 0 0 1-1.028.876 3.11 3.11 0 0 1-.76-2.02A3.136 3.136 0 0 1 4.868-.008h1.687a3.046 3.046 0 0 1 3.046 3.044.675.675 0 1 1-1.35.001c0-.936-.76-1.695-1.696-1.695H4.868Z'
            clipRule='evenodd'
          />
        </>
      );
    case 'clear-format-icon':
      return (
        <>
          <path
            fill={fill}
            fillRule='evenodd'
            d='M3.561 3.895a.675.675 0 0 1 .955 0l3.923 3.924a.675.675 0 1 1-.954.954L3.56 4.85a.675.675 0 0 1 0-.954Z'
            clipRule='evenodd'
          />
          <path
            fill={fill}
            fillRule='evenodd'
            d='M7.963.325c-.532 0-1.043.212-1.42.588L.58 6.877a2.008 2.008 0 0 0 0 2.84l1.37 1.37c.376.376.887.588 1.42.588h1.338c.532 0 1.043-.212 1.42-.588l5.293-5.295a2.008 2.008 0 0 0 0-2.84L9.384.915a2.008 2.008 0 0 0-1.42-.589Zm-.465 1.543a.658.658 0 0 1 .93 0l2.038 2.04a.658.658 0 0 1 0 .93l-5.293 5.294a.658.658 0 0 1-.465.193H3.369a.658.658 0 0 1-.465-.193l-1.369-1.37a.658.658 0 0 1 0-.93l5.963-5.964ZM7.992 11c0-.373.302-.675.675-.675h2.667a.675.675 0 0 1 0 1.35H8.667A.675.675 0 0 1 7.992 11Z'
            clipRule='evenodd'
          />
        </>
      );
    case 'email-signature-icon':
      return (
        <>
          <path
            fill={fill}
            d='M1.521 10.477h.508L5.666 6.84l-.517-.517L1.521 9.96v.517Zm5.811-3.146L4.667 4.657l2.577-2.578-.462-.462-3.418 3.418-1.07-1.062L5.615.643c.327-.327.717-.49 1.171-.49.454 0 .845.163 1.172.49L8.324 1 9.08.244a.804.804 0 0 1 .587-.25c.226 0 .421.083.588.25l1.49 1.49c.167.167.25.364.25.592a.809.809 0 0 1-.25.592L7.332 7.331ZM2.67 11.994H-.005V9.33l4.672-4.672L7.332 7.33 2.67 11.994Z'
          />
        </>
      );
    case 'signature-cross-icon':
      return (
        <>
          <mask
            id='a'
          ...
          <g mask='url(#a)'>
            <path
              fill='#313130'
              d='M4.809 4 7.833.976a.57.57 0 1 0-.808-.808L4.001 3.192.977.168a.57.57 0 1 0-.808.808L3.193 4 .169 7.025a.57.57 0 1 0 .808.808L4 4.808l3.024 3.025a.57.57 0 0 0 .808 0 .57.57 0 0 0 0-.808L4.81 4Z'
            />
          </g>
        </>
      );
    case 'teamcamp-logo':
      return (
        <>
          <path
            fill='#fff'
            d='m12.206 3.592-1.125 2.153 2.264 1.222 1.125-2.152-2.264-1.223Zm1.93 7.32h2.271V8.307h-2.27v2.605Zm-3.055-5.167c-1.224 2.342.446 5.167 3.056 5.167V8.307c-.677 0-1.11-.733-.792-1.34L11.08 5.745ZM7.79 3.592l1.126 2.153-2.263 1.222-1.126-2.152 2.264-1.223Zm-1.93 7.32H3.59V8.307h2.27v2.605Zm3.056-5.167c1.224 2.342-.446 5.167-3.056 5.167V8.307c.677 0 1.11-.733.793-1.34l2.263-1.222ZM7.978 16.408l1.957-2.879-2.108-1.481-1.958 2.879 2.109 1.48Zm1.957-2.879 1.957 2.879 2.109-1.482-1.957-2.878-2.109 1.481Zm0 0a.031.031 0 0 1 .003-.003l-.003.002h-.002l-.001.002h.006l-.001-.001-.002-.001-.002-.002.002.003 2.108-1.481a2.54 2.54 0 0 0-4.216 0l2.108 1.481Z'
          />
        </>
      );
    case 'teamcamp-plus-icon':
      return (
        <>
          <path
            fill='#313130'
            d='M9.144 9.143h5.714a1.141 1.141 0 1 0 0-2.285H9.144V1.143a1.142 1.142 0 1 0-2.286 0v5.715H1.143a1.141 1.141 0 1 0 0 2.285h5.715v5.714A1.14 1.14 0 0 0 8 16c.631 0 1.144-.511 1.143-1.143V9.143Z'
          />
        </>
      );
    case 'done-icon':
      return (
        <>
          <path fill='#7B7A79' d='M16 8A8 8 0 1 0 0 8a8 8 0 0 0 16 0Z' />
          <path
            stroke='#fff'
            fill='none'
            strokeLinecap='round'
            strokeLinejoin='round'
            strokeWidth={1.185}
            d='m11.555 6.222-4.444 4.445L4.444 8'
          />
        </>
      );
    case 'arrow-icon':
      return (
        <>
          <path
            fill='#313130'
            d='M15 5.667v6.666a.667.667 0 1 1-1.333 0V7.276l-7.529 7.529a.665.665 0 0 1-.942 0 .666.666 0 0 1 0-.943l7.528-7.529H7.667a.666.666 0 1 1 0-1.333h6.666a.674.674 0 0 1 .616.412.66.66 0 0 1 .051.255Z'
          />
        </>
      );
    case 'in-progress-icon':
      return (
        <>
          <path
            stroke='#E28512'
            fill='none'
            d='M8 .5a7.5 7.5 0 1 1 0 15 7.5 7.5 0 0 1 0-15Z'
          />
          <path fill='#E28512' d='M8 8V3.333a4.666 4.666 0 1 1 0 9.334V8Z' />
        </>
      );
    case 'in-review-icon':
      return (
        <>
          <path
            ...
            d='M8 .5a7.5 7.5 0 1 1 0 15 7.5 7.5 0 0 1 0-15Z'
          />
          <path fill='#1D8623' d='M8 8V3.333A4.666 4.666 0 1 1 3.333 8H8Z' />
        </>
      );
    case 'backlog-icon':
      return (
        <>
          <path
            fill='#7B7A79'
            fillRule='evenodd'
            d='M9.561.152a8.04 8.04 0 0 0-3.122 0l.194.981a7.04 7.04 0 0 1 2.734 0l.194-.98ZM3.555 1.347l.556.831a7.044 7.044 0 0 0-1.933 1.933l-.83-.556a8.044 8.044 0 0 1 2.207-2.208ZM.152 6.44l.981.194a7.04 7.04 0 0 0 0 2.734l-.98.194a8.04 8.04 0 0 1 0-3.122Zm1.195 6.006.831-.556a7.045 7.045 0 0 0 1.933 1.933l-.556.83a8.043 8.043 0 0 1-2.208-2.207Zm5.092 3.403.194-.981a7.033 7.033 0 0 0 2.734 0l.194.98a8.039 8.039 0 0 1-3.122 0Zm6.006-1.196-.556-.83a7.046 7.046 0 0 0 1.933-1.933l.83.556a8.042 8.042 0 0 1-2.207 2.207Zm3.403-5.09-.981-.195a7.033 7.033 0 0 0 0-2.734l.98-.194a8.039 8.039 0 0 1 0 3.122Zm-1.196-6.007-.83.556a7.045 7.045 0 0 0-1.933-1.933l.556-.83a8.043 8.043 0 0 1 2.207 2.207Z'
            clipRule='evenodd'
          />
        </>
      );
      ...
      return (
        <>
          <path
            ...
            strokeLinecap='round'
            strokeLinejoin='round'
            d='M8 15.5A7.5 7.5 0 0 1 .5 8 7.5 7.5 0 0 1 8 .5 7.5 7.5 0 0 1 15.5 8 7.5 7.5 0 0 1 8 15.5Z'
          />
        </>
      );
    case 'complete-icon':
      ...
      return (
        <>
          ...
          <path
            ...
            strokeLinejoin='round'
            strokeWidth={1.185}
            d='m5.083 5.083 5.834 5.834M10.917 5.083l-5.833 5.834'
          />
        </>
      );
        ...
        <>
          <g clipPath='url(#a)'>
            ...
            <g mask='url(#b)'>
              <path
                fill='#7B7A79'
                d='m7.213 6 4.537-4.536A.856.856 0 1 0 10.538.252L6 4.788 1.464.252A.856.856 0 1 0 .252 1.464L4.79 6 .252 10.537a.856.856 0 1 0 1.212 1.212l4.537-4.537 4.537 4.537a.855.855 0 0 0 1.212 0 .856.856 0 0 0 0-1.212L7.213 6Z'
              />
            </g>
          </g>
          <defs>
    ...
    case 'reply-icon':
      return (
        <>
          <path
            fill='#7B7A79'
            d='M5.333 3.664c2 0 6.667.333 6.667 4.663 0 1.139-.312 2.122-.722 2.843-.161.283-.594.176-.59-.151.022-1.711-.313-3.358-5.355-3.358v2.337a.66.66 0 0 1-1.139.452L.242 6.27a.885.885 0 0 1 0-1.216L4.194.874a.66.66 0 0 1 1.14.453v2.337Z'
          />
        </>
      );
    ...
    case 'chart-tooltip-icon':
      return (
        <>
          <path
            fill='#7B7A79'
            d='M6 12A6 6 0 1 0 6 0a6 6 0 0 0 0 12Zm.45-3.3a.45.45 0 0 1-.9 0V5.957a.45.45 0 0 1 .9 0V8.7Zm-.462-5.4c.331 0 .603.269.603.6 0 .331-.266.6-.597.6h-.006a.6.6 0 1 1 0-1.2Z'
          />
        </>
      );
    case 'calendar-icon':
      return (
        <>
          <path
            fill='#313130'
            d='M11.684 5.084v5.021c0 1.263-.631 1.895-1.895 1.895H2.211C.947 12 .316 11.368.316 10.105v-5.02a.19.19 0 0 1 .19-.19h10.989a.19.19 0 0 1 .19.19ZM9.79 1.58H9V.63a.477.477 0 0 0-.474-.473.477.477 0 0 0-.473.473v.948H3.947V.63a.477.477 0 0 0-.473-.473A.477.477 0 0 0 3 .63v.948h-.79C.948 1.579.317 2.21.317 3.474v.284c0 .105.084.19.19.19h10.989a.19.19 0 0 0 .19-.19v-.284c0-1.264-.632-1.895-1.896-1.895Z'
          />
        </>
      );
    ...
    case 'heading1-icon':
      return (
        <>
          <path
            fill={fill}
            d='M7.451 9.429a.643.643 0 0 1-1.286 0V6.643H2.308v2.786a.643.643 0 0 1-1.286 0V2.57a.643.643 0 0 1 1.286 0v2.786h3.857V2.571a.643.643 0 0 1 1.286 0V9.43ZM10.502 10.071c-.285 0-.48-.191-.48-.482V6.292h-.018l-.674.47a.393.393 0 0 1-.255.085.329.329 0 0 1-.339-.344c0-.147.058-.256.208-.361l.913-.632a.895.895 0 0 1 .574-.182c.342 0 .546.207.546.54v3.721c0 .29-.191.482-.475.482Z'
          />
        </>
      );
    ...
    case 'heading2-icon':
      return (
        <>
          <path
            fill={fill}
            d='M6.94 9.429a.643.643 0 0 1-1.285 0V6.643H1.797v2.786a.643.643 0 0 1-1.285 0V2.57a.643.643 0 0 1 1.285 0v2.786h3.858V2.571a.643.643 0 0 1 1.285 0V9.43ZM8.66 10.071c-.29 0-.434-.162-.434-.395 0-.174.067-.29.254-.462l1.316-1.258c.544-.523.685-.737.685-1.055 0-.365-.281-.625-.676-.625-.355 0-.6.178-.76.533-.103.183-.21.27-.41.27-.247 0-.394-.148-.394-.377 0-.07.012-.135.034-.2.15-.489.703-.945 1.539-.945.936 0 1.567.527 1.567 1.286 0 .538-.263.875-.986 1.557l-.954.918v.019h1.664c.24 0 .383.144.383.367 0 .217-.144.367-.383.367H8.66Z'
          />
        </>
      );
    case 'heading3-icon':
      return (
        <path
          fill={fill}
          d='M6.897 9.429a.643.643 0 0 1-1.285 0V6.643H1.754v2.786a.643.643 0 0 1-1.285 0V2.57a.643.643 0 0 1 1.285 0v2.786h3.858V2.571a.643.643 0 0 1 1.285 0V9.43ZM9.816 10.071c-.839 0-1.355-.363-1.562-.796a.662.662 0 0 1-.07-.29c0-.238.152-.388.406-.388.183 0 .299.073.39.241.156.308.394.492.852.492.451 0 .763-.263.763-.63.003-.426-.312-.665-.846-.665h-.192c-.223 0-.351-.13-.351-.33 0-.191.128-.326.351-.326h.18c.46 0 .76-.25.76-.61 0-.354-.238-.59-.684-.59-.372 0-.598.157-.741.468-.101.207-.208.284-.415.284-.257 0-.388-.15-.388-.373 0-.103.021-.192.067-.296.196-.43.696-.79 1.474-.79.931 0 1.56.46 1.56 1.166 0 .558-.4.924-.919 1.031v.019c.656.06 1.08.445 1.08 1.053 0 .8-.692 1.33-1.715 1.33Z'
        />
      );

    case 'bulleted-list-icon':
      return (
        <>
          <g fill={fill} clipPath='url(#a)'>
            <path d='M1.5 3.375a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Zm3-1.5a.75.75 0 0 1 .75-.75h6a.75.75 0 0 1 0 1.5h-6a.75.75 0 0 1-.75-.75ZM3 6a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0ZM4.5 6a.75.75 0 0 1 .75-.75h6a.75.75 0 0 1 0 1.5h-6A.75.75 0 0 1 4.5 6ZM3 10.125a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0ZM4.5 10.125a.75.75 0 0 1 .75-.75h6a.75.75 0 0 1 0 1.5h-6a.75.75 0 0 1-.75-.75Z' />
          </g>
          <defs>
            <clipPath id='a'>
              <path fill='#fff' d='M0 0h12v12H0z' />
    ...
    case 'number-list-icon':
      return (
        <>
          <path
            fill={fill}
            fillRule='evenodd'
            d='M4.658 2.668c0-.373.302-.675.675-.675h6a.675.675 0 1 1 0 1.35h-6a.675.675 0 0 1-.675-.675ZM1.758.377c.252.105.417.351.417.624v2.658h.158a.675.675 0 1 1 0 1.35H.666a.675.675 0 0 1 0-1.35h.159V2.491a.675.675 0 0 1-.636-1.134l.833-.833a.675.675 0 0 1 .736-.147ZM4.675 9.332c0-.373.302-.675.675-.675h5.9a.675.675 0 1 1 0 1.35h-5.9a.675.675 0 0 1-.675-.675ZM-.009 7.665c0-.372.302-.675.675-.675h1.667c.373 0 .675.303.675.675V9a.675.675 0 0 1-.328.579l-1.243.746H2.5a.675.675 0 1 1 0 1.35H.666a.675.675 0 0 1-.675-.675v-1c0-.237.125-.457.328-.579l1.339-.803V8.34H.666a.675.675 0 0 1-.675-.675Z'
            clipRule='evenodd'
          />
        </>
      );

    case 'check-list-icon':
      return (
        <>
          <g
            fill={fill}
            ...
            clipRule='evenodd'
          >
            <path d='M3.402.22 1.81 1.81l-.53-.53A.75.75 0 1 0 .22 2.341l1.057 1.057.003.004a.747.747 0 0 0 1.061 0l.004-.004L4.462 1.28A.75.75 0 0 0 3.402.22ZM6.75.75h4.5a.75.75 0 0 1 0 1.5h-4.5a.75.75 0 0 1 0-1.5ZM3.402 4.41 1.81 6l-.53-.53A.75.75 0 1 0 .22 6.53l1.057 1.058.003.003a.747.747 0 0 0 1.061 0l.004-.004L4.462 5.47a.75.75 0 0 0-1.06-1.06Zm3.348.53h4.5a.75.75 0 0 1 0 1.5h-4.5a.75.75 0 0 1 0-1.5ZM3.402 8.47 1.81 10.06l-.53-.53A.75.75 0 0 0 .22 10.591l1.057 1.057.003.004a.747.747 0 0 0 1.061 0l.004-.004L4.462 9.53a.75.75 0 0 0-1.06-1.06ZM6.75 9h4.5a.75.75 0 0 1 0 1.5h-4.5a.75.75 0 0 1 0-1.5Z' />
          </g>
          <defs>
            <clipPath id='a'>
              <path fill='#fff' d='M0 0h12v12H0z' />
    ...
    case 'attachment-file-icon':
      return (
        <>
          <path
            fill={fill}
            d='M4.988 12a4.357 4.357 0 0 1-3.113-1.276C.145 8.989.171 6.14 1.933 4.374L5.37.928A3.134 3.134 0 0 1 7.605 0C8.45 0 9.242.329 9.84.928a3.175 3.175 0 0 1 0 4.477L6.386 8.868c-.71.711-1.95.712-2.66 0a1.888 1.888 0 0 1 0-2.663L6.76 3.163a.6.6 0 1 1 .85.848L4.576 7.053a.687.687 0 0 0 0 .967.694.694 0 0 0 .96 0L8.99 4.558a1.974 1.974 0 0 0 0-2.783c-.74-.742-2.03-.742-2.77 0L2.783 5.221c-1.274 1.278-1.3 3.41-.057 4.655a3.167 3.167 0 0 0 2.262.924c.888 0 1.755-.357 2.376-.98l3.016-3.026a.6.6 0 1 1 .85.847l-3.017 3.025A4.585 4.585 0 0 1 4.988 12Z'
          />
        </>
      );

    case 'slash-code-block-icon':
      return (
        <>
          <path
            fill={fill}
            d='M3 9a.598.598 0 0 1-.424-.176l-2.4-2.4a.6.6 0 0 1 0-.848l2.4-2.4a.6.6 0 1 1 .848.848L1.45 6l1.975 1.976A.6.6 0 0 1 3 9Zm6.424-.176 2.4-2.4a.6.6 0 0 0 0-.848l-2.4-2.4a.6.6 0 1 0-.848.848L10.552 6 8.576 7.976a.6.6 0 1 0 .848.848Zm-4.662 2.187 3.6-9.6A.6.6 0 1 0 7.24.989l-3.6 9.6a.6.6 0 1 0 1.123.422Z'
          />
        </>
      );
    case 'divider-icon':
      return (
        <>
          <g fill={fill} clipPath='url(#a)'>
            <path d='M10.286 4.286H1.714a1.714 1.714 0 1 0 0 3.428h8.572a1.714 1.714 0 1 0 0-3.428ZM11.143 9.429H.857a.857.857 0 0 0 0 1.714h10.286a.857.857 0 0 0 0-1.714ZM11.143.857H.857a.857.857 0 1 0 0 1.715h10.286a.857.857 0 0 0 0-1.715Z' />
          </g>
          <defs>
            <clipPath id='a'>
              <path fill='#fff' d='M0 0h12v12H0z' />
    ...
    case 'table-icon':
      return (
        <>
          <path
            fill={fill}
            d='M.2 5.167h5.1c.11 0 .2.089.2.2V7.3a.2.2 0 0 1-.2.2H.2a.2.2 0 0 1-.2-.2V5.367c0-.111.09-.2.2-.2ZM0 8.7v.633c0 1.334.667 2 2 2h3.3a.2.2 0 0 0 .2-.2V8.7a.2.2 0 0 0-.2-.2H.2a.2.2 0 0 0-.2.2ZM10 .667H2c-1.333 0-2 .666-2 2v1.3c0 .11.09.2.2.2h11.6a.2.2 0 0 0 .2-.2v-1.3c0-1.334-.667-2-2-2Zm-3.5 4.7V7.3c0 .11.09.2.2.2h5.1a.2.2 0 0 0 .2-.2V5.367a.2.2 0 0 0-.2-.2H6.7a.2.2 0 0 0-.2.2Zm0 3.333v2.433c0 .111.09.2.2.2H10c1.333 0 2-.666 2-2V8.7a.2.2 0 0 0-.2-.2H6.7a.2.2 0 0 0-.2.2Z'
          />
        </>
      );
  }
